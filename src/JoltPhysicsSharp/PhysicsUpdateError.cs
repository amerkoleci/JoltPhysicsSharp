...
public enum PhysicsUpdateError
{
    ...
    /// Some contacts were ignored. Increase maxContactConstraints in <see cref="PhysicsSystem.Init(uint, uint, uint, uint, BroadPhaseLayerInterface, ObjectVsBroadPhaseLayerFilter, ObjectLayerPairFilter)"/>.
    /// </summary>
    ManifoldCacheFull = 1 << 0,
    /// <summary>
    /// The body pair cache is full, this means that too many bodies contacted. Some contacts were ignored.
    /// Increase maxBodyPairs in <see cref="PhysicsSystem.Init(uint, uint, uint, uint, BroadPhaseLayerInterface, ObjectVsBroadPhaseLayerFilter, ObjectLayerPairFilter)"/>.
    /// </summary>
	BodyPairCacheFull = 1 << 1,
    /// <summary>
    /// The contact constraints buffer is full. Some contacts were ignored.
    /// Increase inMaxContactConstraints in <see cref="PhysicsSystem.Init(uint, uint, uint, uint, BroadPhaseLayerInterface, ObjectVsBroadPhaseLayerFilter, ObjectLayerPairFilter)"/>.
    /// </summary>
